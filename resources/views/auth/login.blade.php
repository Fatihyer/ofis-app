                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="password" class="col-lg-4 col-form-label text-lg-right">Yıl</label>
                            <div class="col-lg-6">
                        <label for="year">Annee</label>
                       Pour 2025 et avant <a href="http://ofis2025.parisvia.com/login">ofis2025.parisvia.com</a></br> 
                        Pour 2026 <a href="http://ofis.parisvia.com">ofis.parisvia.com</a>
                        </div>
                        </div>
