...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
      //  \App\Http\Middleware\CustomSessionTimeout::class,
     ...
     *
     * These middleware may be assigned to groups or used indi  vidually.
     *
     * @var array
     */
    protected $routeMiddleware = [
        ...
        'report.token' => \App\Http\Middleware\ReportToken::class,
