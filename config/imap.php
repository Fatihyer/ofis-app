    ...
    */
    'accounts' => [
        ...
        'contact' => [
            ...
            'username' => env('IMAP_USERNAME', 'contact@parivia.com'),
            'password' => env('IMAP_PASSWORD', 'yeniparisVIA2025!'),
        ...
        'resparis' => [
            ...
            'encryption'    => env('IMAP_ENCRYPTION', 'ssl'),
            'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            'username' => env('IMAP_USERNAME_RESPARIS', 'contact@parisvia.com'),
            'password' => env('IMAP_PASSWORD_RESPARIS', 'yeniparisVIA2025!'),
            'authentication' => env('IMAP_AUTHENTICATION', null),
            'proxy' => [
                'socket' => null,
                'request_fulluri' => false,
        ...
        'contactfrance' => [
            ...
            'encryption'    => env('IMAP_ENCRYPTION', 'ssl'),
            'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            'username' => env('IMAP_USERNAME_CONTFRANCE', 'contact@francevia.com'),
            'password' => env('IMAP_PASSWORD_CONTFRANCE', 'contactFRANCEVIA2024*'),
            'authentication' => env('IMAP_AUTHENTICATION', null),
            'proxy' => [
                'socket' => null,
                'request_fulluri' => false,
        ...
        'resfrance' => [
            ...
            'encryption'    => env('IMAP_ENCRYPTION', 'ssl'),
            'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            'username' => env('IMAP_USERNAME_RESFRANCE', 'contact@parisvia.com'),
            'password' => env('IMAP_PASSWORD_RESFRANCE', 'yeniparisVIA2025!'),
            'authentication' => env('IMAP_AUTHENTICATION', null),
            'proxy' => [
                'socket' => null,
                'request_fulluri' => false,
        ...
        'paris' => [
            ...
            'encryption'    => env('IMAP_ENCRYPTION', 'ssl'),
            'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            'username' => env('IMAP_USERNAME_PARIS', 'paris@parisvia.com'),
            'password' => env('IMAP_PASSWORD_PARIS', env('IMAP_PASSWORD_RESPARIS', env('IMAP_PASSWORD'))),
            'authentication' => env('IMAP_AUTHENTICATION', null),
            'proxy' => [
                'socket' => null,
                'request_fulluri' => false,
        ...
        'sales' => [
            ...
            'encryption'    => env('IMAP_ENCRYPTION', 'ssl'),
            'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            'username' => env('IMAP_USERNAME_SALES', 'sales@parisvia.com'),
            'password' => env('IMAP_PASSWORD_SALES', env('IMAP_PASSWORD_RESPARIS', env('IMAP_PASSWORD'))),
            'authentication' => env('IMAP_AUTHENTICATION', null),
            'proxy' => [
                'socket' => null,
                'request_fulluri' => false,
        ...
        'sales2' => [
            ...
            'encryption'    => env('IMAP_ENCRYPTION', 'ssl'),
            'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            'username' => env('IMAP_USERNAME_SALES2', 'sales2@parisvia.com'),
            'password' => env('IMAP_PASSWORD_SALES2', env('IMAP_PASSWORD_RESPARIS', env('IMAP_PASSWORD'))),
            'authentication' => env('IMAP_AUTHENTICATION', null),
            'proxy' => [
                'socket' => null,
                'request_fulluri' => false,
